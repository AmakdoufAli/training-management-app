    ...
    return (
        <form onSubmit={(e)=>SendInfos(e)} className="flex flex-col gap-4">
            ...
            <div className="space-y-2">
                ...
                <textarea name="contenu" id="contenu" onChange={(e)=>{setNotificationData({...notificationData, contenu: e.target.value})}} rows="6" className="block p-2.5 w-full text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300" required></textarea>
            </div>
