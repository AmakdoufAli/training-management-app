...
export default function Step3(props){
    ...
    // useEffect(()=>{
    //     const participationData = checkedFormateurs.map(f=> {
    //         return {formateur_id: f, formation_id: props.formationId};
    //     })
        ...
        if(btn == 1){
            ...
            if(participationData.formateursIds.length == 0){
                ...
                try{
                    ...
                    postParticipation(participationData);
                    axios.put(`http://127.0.0.1:8000/api/formations/${props.formationId}`, {"etat":1})
                }catch(err){
