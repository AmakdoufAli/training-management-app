...
export default function Afficher(props){
    ...
    const deleteUser = async(id) =>{
        if(window.confirm('Vouler-vous vraiment supprimer l\'utilisateur avec id '+ id + ' ?')){
            try{
    ...
    return (
        <div className="bg-white mb-32">
            ...
            <div className="mx-3 my-6">
              <Link to={"/ajouterUser"} className="py-2 px-6 text-md font-medium text-center text-white rounded-lg bg-blue-4">Ajouter Utilisateur</Link>
            </div>
